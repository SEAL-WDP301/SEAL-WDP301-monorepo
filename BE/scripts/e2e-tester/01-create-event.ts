...
async function main() {
  ...
  const newEvent = await prisma.event.create({
    data: {
      name: eventName,
      description:
        "A comprehensive hackathon event designed to push the boundaries of technology in AI and Web3.",
      season: "Fall",
      year: 2026,
      ...
      prizes: {
        create: [
          {
            name: "1st Prize",
            description: "$5,000 Cash + 10,000 AWS Credits",
            quantity: 1,
          },
          {
            name: "2nd Prize",
            description: "$3,000 Cash + 5,000 AWS Credits",
            quantity: 1,
          },
          {
            name: "3rd Prize",
            description: "$1,000 Cash + 2,000 AWS Credits",
            quantity: 1,
          },
          {
            name: "Honorable Mention",
            description: "Exclusive Swag package + 1,000 AWS Credits",
            quantity: 1,
          },
        ],
      },
      ...
      tracks: {
        create: [
          {
            name: "AI & Data Track",
            description: "Focus on AI, ML, Data Science",
          },
          {
            name: "Web3 & Blockchain",
            description: "Focus on decentralization",
          },
        ],
      },
    },
